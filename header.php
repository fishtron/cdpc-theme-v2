...
<head>
	...
	<link href="https://fonts.googleapis.com/css?family=Faustina:400,700|Montserrat:300,400,400i&display=swap" rel="stylesheet">
	<?php wp_head(); ?>
</head>
...
<div class="site" id="page">
	...
	<div id="wrapper-navbar" itemscope itemtype="http://schema.org/WebSite">
		...
		<header class="navbar utility bg-primary">	
		...
		<?php endif; ?>
				...
				<div class="pull-right">
				  ...
				  <div class="inline-form header-search">
						<?php get_search_form(); ?>
			    </div>
				</div>
